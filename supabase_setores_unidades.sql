...
-- ------------------------------------------------------------
-- 2) Evita duplicar o mesmo Setor pra mesma Unidade (também é o que
...
-- ------------------------------------------------------------
-- 3) RLS: faltava UPDATE/DELETE em tabelas_apoio (só existia SELECT e
...
-- ------------------------------------------------------------
-- 4) Popula "unidades" (metadados) com as Unidades da planilha que
...
-- ------------------------------------------------------------
-- 5) Popula "tabelas_apoio" (Unidade + Setor + E-mail, usada nos
