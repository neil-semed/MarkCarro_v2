...
async function carregarProximasAgendas() {
  ...
  try {
    ...
    // PEDIDO DO USUÁRIO: "tela Próximas - somente apresentar viagens com
    // status confirmada" - sem isso, corridas ainda Pendente/Em Análise (ou
    // já Cancelada/Ocupado, que mantêm o condutor salvo mesmo depois de
    // desmarcadas) apareciam aqui como se fossem compromissos garantidos.
