...
async function salvarNovaSenha() {
  ...
  try {
    ...
    // PEDIDO DO USUÁRIO: não navegar sozinho pra outra tela ao finalizar/
    // salvar - antes chamava voltarDaAlterarSenha() aqui, que já existe e
    // continua sendo usada pelo botão "Voltar" (navegação manual, com o
    // usuário clicando, continua normal). Só limpa os campos de senha.
    document.getElementById('form-alterar-senha').reset();
  } catch (e) {
