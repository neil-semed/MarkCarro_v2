...
async function salvarUsuarioGestor() {
  ...
  try {
    ...
    if (emailOriginal) {
      ...
      // Mesma correção defensiva de gerenciar-condutores.js: garante
      // "ativo: true" explicitamente aqui, sem depender do DEFAULT da
      // coluna no banco (ver comentário lá para o caso real que isso evita).
