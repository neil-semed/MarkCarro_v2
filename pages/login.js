...
function carregarPainelPorPerfil() {
  ...
  if (tipo === 'admin') {
    ...
    // Topo: saudação centralizada, botão de Pane Mecânica e sino - sem
    // favicon (pedido do usuário: "tire o fivecon") e sem botão de Sair
    // direto (pedido anterior: "tire o botão sair do topo" - continua no
    // menu do avatar).
    //
