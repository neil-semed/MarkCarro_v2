...
function carregarSaudacao() {
  ...
  // O nome aparecia duas vezes (aqui do lado do avatar E na saudação em
  // destaque logo abaixo) - removido daqui; o avatar agora mostra só as
  // iniciais. Os demais usam "?." de propósito: um elemento removido ou
